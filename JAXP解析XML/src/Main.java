...
public class Main {
    ...
    //DOM 解析器的工厂，解析器对象，要解析的文件，解析后的Document对象
    ...
    public Main() throws Exception{
        ...
        is = new FileInputStream("java.xml");
    ...
    public static void main(String[] args) throws Exception{
        Main m = new Main();
        System.out.println("--------------------------------------------------------------------------------------");
        m.findNodeByTag(document,"teacher");
        System.out.println("--------------------------------------------------------------------------------------");

        m.findNodeByAttrValue(document.getDocumentElement(),"name","华");
        System.out.println("--------------------------------------------------------------------------------------");

        Element e2 = (Element)m.findNodeById(document,"x121");
        System.out.println(e2.getTagName());
        System.out.println("--------------------------------------------------------------------------------------");

        // m.deleteNodeById(document,"id");
    }
